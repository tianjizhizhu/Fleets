...
<template>
  <nav
    class="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-t border-paper-3 safe-bottom"
  >
      ...
      >
        <div class="relative">
          ...
          <span
            ...
            class="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1.5 flex items-center justify-center text-[10px] font-medium text-white bg-error rounded-full shadow-sm"
          >
